...
This class is copyright 2016 Fabian M. Suchanek. Test
...
public abstract class SimpleDeduplicator extends Extractor {
    ...
    public void extract() throws Exception {
        ...
        if (!input().contains(SchemaExtractor.YAGOSCHEMA)) {
            Announce.warning(
                    "Deduplicators should have SchemaExtractor.YAGOSCHEMA, in their required input so that they can check functional relations!");
        }
        else {
