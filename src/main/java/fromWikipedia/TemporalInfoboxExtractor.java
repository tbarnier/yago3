            ...
            switch (FileLines.findIgnoreCase(in, "<title>", "<comment>", "{{")) {
                ...
                default:
                    ...
                    if (type != null && type.length() > 3) {
                        write(INFOBOXTYPES, new Fact(null, titleEntity, RDFS.type, type), TEMPORALINFOBOXSOURCES,
                                FactComponent.wikipediaURL(titleEntity), "TemporalInfoboxExtractor: Preferred meaning of infobox type " + cls);
                    }
                ...
                for (int i = 0; i < objects.size(); i++) {
                    ...
                    if (inverse) {
                        ...
                        if (baseFact.getArg(2).contains("xsd:date")) // type
                            // checking
                            // for dates
                            write(TEMPORALDIRTYINFOBOXFACTS, new Fact(object, relation, entity), TEMPORALINFOBOXSOURCES,
            ...
            for (String object : objects) {
                ...
                if (inverse)
                    ...
                    if (i == 0) {
                        ...
                        if (!baseFact.getRelation().equals("")) {
