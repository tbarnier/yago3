...
public class FlightExtractor extends EnglishWikipediaExtractor {
    ...
    public Set<FollowUpExtractor> followUp() {
        return new FinalSet<>(new Redirector(FLIGHTSNEEDRED, FLIGHTSNEEDTYPE, this), new TypeChecker(FLIGHTSNEEDTYPE, FLIGHTS, this));
    }

    /** Constructor from source file */
    public FlightExtractor(File wikipedia) throws IOException {
        super(wikipedia);
    }
