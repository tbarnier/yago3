...
public class CategoryHierarchyExtractor extends MultilingualWikipediaExtractor {
    ...
    public Set<FollowUpExtractor> followUp() {
        ...
        return (new FinalSet<FollowUpExtractor>(new CategoryTranslator(CATEGORYHIERARCHY.inLanguage(this.language),
                CATEGORYHIERARCHY_TRANSLATED.inLanguage(this.language), this, true, false)));
    }
            ...
            switch (FileLines.findIgnoreCase(in, "<title>", "[[Category:", "[[" + categoryWord + ":")) {
                ...
                case 0:
                    ...
                    if (title.startsWith("Category:")) {
                        ...
                        if (title.startsWith(categoryTitlePrefix)) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new CategoryHierarchyExtractor("en", new File("c:/fabian/data/wikipedia/roxana.xml")).extract(new File("data"),
