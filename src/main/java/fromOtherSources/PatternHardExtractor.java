...
public class PatternHardExtractor extends HardExtractor {
    ...
    public Set<Theme> output() {
        return (new FinalSet<Theme>(INFOBOXPATTERNS, INFOBOXTEMPORALPATTERNS, INFOBOXREPLACEMENTS, TITLEPATTERNS, CATEGORYPATTERNS, RULES,
                DISAMBIGUATIONTEMPLATES, CONTEXTPATTERNS, STRUCTUREPATTERNS, LANGUAGECODEMAPPING, SPOTLX_ENTITY_RULES, SPOTLX_FACT_RULES,
                STRINGPARSER, NUMBERPARSER, DATEPARSER, AIDACLEANINGPATTERNS, FALSEFACTS, MULTILINGUALATTRIBUTES));
    }
    ...
    public PatternHardExtractor(File inputFolder) throws IOException {
        super(inputFolder);
    }

    public PatternHardExtractor() throws IOException {
        this(new File("./data"));
    }
