...
public class InfoboxTypeExtractor extends MultilingualExtractor {
    ...
    public Set<Theme> input() {
        if (isEnglish())
            return (new FinalSet<Theme>(InfoboxExtractor.INFOBOX_TEMPLATES.inLanguage(language), PatternHardExtractor.INFOBOXPATTERNS,
                    WordnetExtractor.PREFMEANINGS));
        else
            return (new FinalSet<Theme>(InfoboxExtractor.INFOBOX_TEMPLATES_TRANSLATED.inLanguage(language), PatternHardExtractor.INFOBOXPATTERNS,
                    WordnetExtractor.PREFMEANINGS));
    }
