...
public class AllEntitiesTypesExtractorFromYagoWordnetPrefMeanings extends Extractor {
    ...
    public void extract() throws Exception {
        ...
        Announce.done(this.getClass().getName() + " #Wikidata entities in all langs: " + temp_wd_ents
                + "#Entities not available in Wikidata but in Wikipedia: " + (done.size() - temp_wd_ents));
    }
