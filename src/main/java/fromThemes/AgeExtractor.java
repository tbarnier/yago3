...
public class AgeExtractor extends Extractor {
    ...
    public void extract() throws Exception {
        ...
        Map<String, String> birthdates = new HashMap<>();
        Map<String, String> deathdates = new HashMap<>();
    ...
    private static boolean hasYear(String date) {
        ...
        return (pos > 0 && Character.isDigit(date.charAt(pos - 1)));
    }
