...
public abstract class AttributeMappingMeasure {
    ...
    public String toString() {
        if (threshold == (int) threshold)
            return String.format(Locale.US, "%s(%d)", this.getClass().getSimpleName(), (int) threshold);
        else
            return String.format(Locale.US, "%s(%.3f)", this.getClass().getSimpleName(), threshold);
    }
    ...
    public boolean equals(Object arg0) {
        return arg0.getClass().equals(this.getClass())
                && Math.round(((AttributeMappingMeasure) arg0).threshold * 1000) == Math.round(threshold * 1000);
    }
