...
public class LocationNames {
    ...
    public static final Pattern mainPartPattern = Pattern.compile(
    ...
    private String print() {
        ...
        for (Map.Entry<String, Set<String>> loc : locationToPart.entrySet()) {
            sb.append(loc.getKey()).append(" --> ").append(loc.getValue()).append("\n");
        }

        sb.append("--------------------------------------------------------------------------------");

        for (Map.Entry<String, Set<String>> part : partToLocation.entrySet()) {
    ...
    public static void main(String[] args) {
        ...
        ln.populate();
        log.info(ln.locationToPart.get("<Holy_Roman_Empire>").toString());
        log.info(ln.partToLocation.get("Phoenician").toString());

        // ln.printToFile("data/locations/locationsToMainPart.txt");

        log.info(ln.locations("<wikicat_14th-century_Roman_Catholic_bishops").toString());
    }
