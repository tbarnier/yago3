...
public class WikipediaTextCleanerHelper {
    ...
    */
    public static final PatternList internalLinks = new PatternList(
            Arrays.asList(new Pair<>(Pattern.compile("\\[\\[[^\\]\\n]+?\\|([^\\]\\n]+?)\\]\\]"), "$1"),
    ...
    */
    public static final PatternList categoryLinks = new PatternList(
            Arrays.asList(new Pair<>(Pattern.compile("\\[\\[Category:(.+?)\\]\\]", Pattern.CASE_INSENSITIVE), ""),
     ...
     *  
    */
    public static final PatternList htmlTags = new PatternList(Arrays.asList(new Pair<>(Pattern.compile("<br */>"), "\n"),
            new Pair<>(Pattern.compile("<br *>"), "\n"), new Pair<>(Pattern.compile("</ *br *>"), "\n"), new Pair<>(Pattern.compile("<(.*?)/>"), ""),
            new Pair<>(Pattern.compile("<table.*?>(.*?)</table>"), ""), new Pair<>(Pattern.compile("<gallery.*?>(.*?)</gallery>"), ""),
            new Pair<>(Pattern.compile("<imagemap.*?>(.*?)</imagemap>"), ""), new Pair<>(Pattern.compile("<ref.*?>(.*?)</ref>"), ""),
    ...
    */
    public static final PatternList whiteSpaces = new PatternList(
            Arrays.asList(new Pair<>(Pattern.compile("[\\p{Zl}\\p{Zs}\\p{Zp}\\n]+([\\.!;:,\\?])"), "$1"),
