...
public class GeoNamesDataImporter extends DataExtractor {
    ...
    private Map<Integer, String> extractAllCountries(File geodata, Theme mappedOut, Theme onlyOut, Theme typeOut,
            Map<String, String> geoEntityId2yago, Map<String, String> geoClassId2yago) throws NumberFormatException, IOException {
    ...
    public GeoNamesDataImporter(File geonamesFolder) throws IOException {
        super(geonamesFolder);
    }

    public GeoNamesDataImporter() throws IOException {
